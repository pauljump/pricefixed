...
measure housing stock differently. It has **3,044,628 canonical units** with a
...
a Greystar and UDR capture added 20 more, and Rudin and Spherexx imports added 11
more, bringing the current build to **3,044,628 canonical units**. The last local
...
building-count inference was used to inflate the 3,044,628 total. The next location
