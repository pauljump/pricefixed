...
measure housing stock differently. It has **3,044,561 canonical units** with a
...
The August 7, 2026 local build reached **3,044,550 canonical units**. A subsequent
2026-08-09 SecureCafe capture added 11 net-new source-backed units, bringing the
current build to **3,044,561 canonical units**. The last local
...
building-count inference was used to inflate the 3,044,561 total. The next location
