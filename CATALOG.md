...
measure housing stock differently. It has **3,044,597 canonical units** with a
...
bringing the current build to **3,044,597 canonical units**. The last local
...
building-count inference was used to inflate the 3,044,597 total. The next location
