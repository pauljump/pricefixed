...
measure housing stock differently. It has **3,044,617 canonical units** with a
...
a Greystar capture added 1 more and a UDR capture added 19 more, bringing the
current build to **3,044,617 canonical units**. The last local
...
building-count inference was used to inflate the 3,044,617 total. The next location
