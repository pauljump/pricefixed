...
|---|---|---|---|
| Rockrose | [Linc LIC](https://rockrose.com/building/linc-lic/) | The official page links to a property-specific SecureCafe/RentCafe portal: [`linclicllc-rockrose.securecafe.com`](https://linclicllc-rockrose.securecafe.com/onlineleasing/linc-lic-l-l-c/guestlogin.aspx). Its explicit public AJAX availability endpoint was checked on 2026-08-08 and returned “No apartments were found matching your search request.” | Public portal checked; no current unit rows to ingest |
